...
fun MavenPublication.mavenCentralPom() {
    pom {
        name.set("ktask")
        description.set("Kotlin task runner facade.")
        url.set("https://github.com/mooncloak/ktask")
        ...
        issueManagement {
            url.set("https://github.com/mooncloak/ktask/issues")
        ...
        developers {
            developer {
                ...
                roles.set(setOf("Primary ktask developer. 💪"))
            }
        }

        scm {
            connection.set("https://github.com/mooncloak/ktask.git")
            developerConnection.set("https://github.com/mooncloak/ktask.git")
            url.set("https://github.com/mooncloak/ktask")
        }
    }
}
